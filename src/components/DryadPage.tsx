    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 p-8 font-sans">
      <nav className="flex justify-between items-center mb-16">
        ...
        <div className="space-x-6 text-sm text-zinc-400">
          {['Home', 'Download', 'Versions', 'Tools', 'Docs', 'Code'].map(item => (
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="space-x-4">
            <button className="bg-emerald-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-emerald-500">Get Dryad</button>
            <button className="border border-zinc-700 px-6 py-2 rounded-lg font-medium hover:bg-zinc-800">Read Docs</button>
          </div>
        </div>
      ...
      <section className="mt-24 bg-zinc-900 p-8 rounded-2xl">
        <h3 className="text-sm font-mono text-emerald-400 mb-2">hello.dryad</h3>
